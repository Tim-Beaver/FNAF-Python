...
PyObject *CALL_FUNCTION_WITH_ARGS17_KWSPLIT(PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(function, args, 17, kw_values, kw_names);
...
PyObject *CALL_FUNCTION_WITH_ARGS21_KWSPLIT(PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(function, args, 21, kw_values, kw_names);
        ...
        if (likely(func != NULL)) {
            NUITKA_DYNAMIC_ARRAY_DECL(vectorcall_args, PyObject *, 21 + nkwargs);

            memcpy(vectorcall_args, args, 21*sizeof(PyObject *));
            memcpy(&vectorcall_args[21], kw_values, nkwargs*sizeof(PyObject *));

            PyObject *result = func(called, vectorcall_args, 21, kw_names);
